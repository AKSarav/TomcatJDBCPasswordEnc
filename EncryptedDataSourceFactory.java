...
public class EncryptedDataSourceFactory extends DataSourceFactory {
    ...
    private EncryptJDBCPassword encryptor = null;

    public EncryptedDataSourceFactory() {
        try {
            encryptor = new EncryptJDBCPassword(); // If you've used your own secret key, pass it in...
    ...
    public DataSource createDataSource(Properties properties, Context context, boolean XA) throws InvalidKeyException,
        ...
        String Name = EncryptedDataSourceFactory.getProperties("name").toString();
        String URL = poolProperties.getUrl();
        String username = poolProperties.getUsername();
        Logger.getLogger(EncryptedDataSourceFactory.class.getName()).log(Level.INFO, "Creating a New Connection Pool for DataSource "+Name+" with URL "+URL+" and the  username "+username);
