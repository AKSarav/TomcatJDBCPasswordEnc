 ...
 */
package com.csc.encryptjdbcpassword;
 ...
 * @author aksarav
 */
public class EncryptJDBCPassword {
    
    private static final String ALGORITHM = "AES";

    private static final String defaultSecretKey = "ironman";

    private Key secretKeySpec;

    public EncryptJDBCPassword() throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException,
            UnsupportedEncodingException {
        this(null);
    }

    public EncryptJDBCPassword(String secretKey) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException,
            UnsupportedEncodingException {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length == 1 || args.length == 2) {
            ...
            EncryptJDBCPassword aes = null;
            if (secretKey == null) {
                aes = new EncryptJDBCPassword();
            } else {
                aes = new EncryptJDBCPassword(secretKey);
            }
